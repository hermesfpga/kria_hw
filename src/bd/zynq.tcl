...
if { $list_projs eq "" } {
  ...
  set_property BOARD_CONNECTIONS { som240_2_connector xilinx.com:kd240_carrier:som40_2_connector:1.0 som240_1_connector xilinx.com:kr260_carrier:som240_1_connector:1.1} [current_project]
}
...
proc create_root_design { parentCell } {
  ...
  set UF1 [ create_bd_port -dir O -from 0 -to 0 UF1 ]
  set UF2 [ create_bd_port -dir O -from 0 -to 0 UF2 ]
